<header>
    <div class="container-fluid">
        <div class="row py-2 justify-content-center d-none d-md-flex">
            <div class="col-lg-5 text-center text-lg-start border-bottom py-2">
                <span>
            ...
            <div class="col-lg-5 pe-0 text-center text-lg-end border-bottom py-2">
        ...
        <div class="row mb-3 py-2 d-block d-md-none bg-color1">
        ...
        <div class="row p-0 m-0 sticky-top py-2">
